...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`MatHang` (
  ...
  `MaLH` INT NOT NULL,
  PRIMARY KEY (`MaMH`),
  INDEX `fk_MatHang_LoaiHang1_idx` (`MaLH` ASC),
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`ChiTietMatHang` (
  ...
  INDEX `fk_MatHang_has_KichCo_KichCo1_idx` (`MaKC` ASC) ,
  INDEX `fk_MatHang_has_KichCo_MatHang_idx` (`MaMH` ASC) ,
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`NhanVien` (
  ...
  `MaCV` INT NOT NULL,
  PRIMARY KEY (`MaNV`),
  INDEX `fk_NhanVien_ChucVu1_idx` (`MaCV` ASC) ,
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`DonHang` (
  ...
  `MaLHTT` INT NOT NULL,
  PRIMARY KEY (`MaDH`),
  INDEX `fk_DonHang_NhanVien1_idx` (`MaNV` ASC) ,
  INDEX `fk_DonHang_KhachHang1_idx` (`MaKH` ASC) ,
  INDEX `fk_DonHang_LoaiHinhThanhToan1_idx` (`MaLHTT` ASC) ,
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`ChiTietDonHang` (
  ...
  INDEX `fk_DonHang_has_MatHang_MatHang1_idx` (`MaMH` ASC) ,
  INDEX `fk_DonHang_has_MatHang_DonHang1_idx` (`MaDH` ASC) ,
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`HoaDon` (
  ...
  PRIMARY KEY (`MaHD`),
  INDEX `fk_HoaDon_DonHang1_idx` (`MaDH` ASC) ,
...
CREATE TABLE IF NOT EXISTS `java13_shopping`.`ChiTietTinhTrangDonHang` (
  ...
  INDEX `fk_DonHang_has_TinhTrangDonHang_TinhTrangDonHang1_idx` (`MaTT` ASC) ,
  INDEX `fk_DonHang_has_TinhTrangDonHang_DonHang1_idx` (`MaDH` ASC) ,
  INDEX `fk_ChiTietTinhTrangDonHang_NhanVien1_idx` (`MaNV` ASC) ,
