...
public class Ex05 {
	public static void main(String[] args) {
		Map<Employee, List<Employee>> teams = mockData();
	...
	private static Map<Employee, List<Employee>> mockData() {
		...
		List<Employee> slist = Arrays.asList(new Employee(21, "C", 30, 2), new Employee(22, "D", 30, 2));
		...
		teams.put(new Employee(1,"John", 100, null), slist);
		
		//2 cases : update, addNew
		//expected: update
		//must override the equals method, so the key putted will be considered if it equals to one of keys of Map
		return teams;
	}
}
