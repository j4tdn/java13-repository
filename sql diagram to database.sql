...
-- -----------------------------------------------------
-- Table `java13_shopping_manually`.`KickCoMatHang`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `java13_shopping_manually`.`KickCoMatHang` ;

CREATE TABLE IF NOT EXISTS `java13_shopping_manually`.`KickCoMatHang` (
  `MaMH` INT NOT NULL,
  `MaKC` INT NOT NULL,
  `HinhAnh` TEXT NULL,
