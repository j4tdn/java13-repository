...
public class App {
	...
	public static void main(String[] args) {
		//Ex01
		breakLine("List all employees by department_id");
		...
		//Ex03
		breakLine("List all projects of departments which have budget greater than 400 main days");
		...
		//Ex05
		breakLine("Get department which has project with highest budget in 2020");
