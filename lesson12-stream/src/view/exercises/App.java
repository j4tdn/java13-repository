...
public class App {
	public static void main(String[] args) {
		...
		// 6. Are any traders based in Milan?
		System.out.println(
				"Are any traders based in Milan? : " + traders.stream().allMatch(t -> "Milan".equals(t.getCity())));
		...
		log(values);
		// 9. What’s the highest value of all the transactions?
		Transaction highestValue = transactions.stream().reduce(transactions.get(0),
				(t1, t2) -> t1.getValue() > t2.getValue() ? t1 : t2);
		System.out.println("highest value of all the transactions: " + highestValue.getValue());
		// 10. Find the transaction with the smallest value.
		Transaction smallestValue = transactions.stream().reduce(transactions.get(0),
				(t1, t2) -> t1.getValue() < t2.getValue() ? t1 : t2);
		System.out.println("===================================");
		System.out.println("smallest value of all the transactions: " + smallestValue.getValue());
	}
