...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println("big V: " + bigV);
		
		BigDecimal bigD = BigDecimal.valueOf(99999)
				.multiply(BigDecimal.valueOf(999999999999d));
		System.out.println("bigD: " + bigD);
		
		double decV = 99.99 * 256.56879;  // valueE15 = value * pow(10, 15);
