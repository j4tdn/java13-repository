...
public class App {
	public static void main(String[] args) {
		...
		// Thay vì tạo từng id một cách thủ công thì ↓
		...
		System.out.println("Order 1: " + OrderUtils.export(o1)); // Hàm này ko quan tâm đến đối tượng đang gọi, chỉ quan tâm đến đối tượng truyền vào
		System.out.println("Order 2: " + OrderUtils.export(o2));
		System.out.println("Order 3: " + OrderUtils.export(o3));
		
	// Way 1: Write method export in Order class: no-parameter
	// Way 2: Write method export in Anther class: export(order)
