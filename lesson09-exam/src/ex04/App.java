...
/**
 * Viết chương trình thực hiện chức năng đăng ký tài khoản B1. Nhập tên tài
 * khoản ví dụ byztkhx256 B2. Nhập mật khẩu admin123 Validation 1. Độ dài mật
 * khẩu: >= 8 2. Có ít nhất 1 chữ số, 1 kí tự in hoa, và một kí tự đặc biệt
...
public class App {
	...
	public static boolean validate(String username, String password) {
		...
		// => USING STRATEGY CONDITION
 //		return 
//		check(password, new Condition() {
//			@Override
...
//			@Override
//			public boolean check(char letter) {
//				return SPECIAL_LETTERS.contains("" + letter);
//			}});

	}

	private static boolean check(String string, Condition condition) {
		char[] letters = string.toCharArray();
		for (char letter : letters) {
			if (condition.check(letter)) {
				return true;
			}
		}
