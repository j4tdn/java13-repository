...
public class Ex05 {
	...
	public static void main(String[] args) {
		...
		// Hàm contains dùng hàm equals nên chỉ cần override hàm equals
		System.out.println("Is exist ?: " + items.contains(item));
		items.remove(item); // tương tự hàm contains, override hàm equals
		System.out.println("=======================");
		printf(items);
		
		System.out.println("=======================");
		// Ex01 ex01 = new Ex01();
		// System.out.println("equals: " + items.equals(ex01));
	}
