...
public class Ex03 {
	/**
	 * Basic operations SOT: construct, add, for each, size, get, set,
	 * iterate(before 1.5), remove, contains internal build
	 *
	...
	statuses.add("ORDER");statuses.add("PACKAGE");statuses.add("DELIVERY");statuses.add("RECEIVED");

	statuses.set(3,"BOOM");

	System.out.println("size: "+statuses.size());System.out.println("statusus[1]: "+statuses.get(1));for(
	...
	// _DELIVERY
	// _
	Iterator<String> iterator = statuses.iterator();while(iterator.hasNext())
	{
